...
use crate::{
    configuration::ProviderRepository, connection_verification::verify_remote_folder,
...
fn verify_remote(
    ...
    let transport = runtime
        .block_on(crate::s3_transport::S3Transport::connect(
            &provider,
            credentials,
        ))
...
#[cfg(test)]
#[path = "connection_verification_worker_tests.rs"]
mod tests;
