...
use crate::{
    operations::archive::retention::{ArchiveRecord, ArchiveRetentionError, prune_after_success},
...
pub enum ArchivePruneError<E> {
    ...
    Cancelled {
        #[allow(
            dead_code,
            reason = "partial removals are retained so recovery callers can reconcile history"
        )]
...
mod tests {
    ...
    use crate::{
        configuration::ConnectionId, operations::archive::retention::ArchiveRecord,
        operations::cancellation::CancellationToken,
    };
