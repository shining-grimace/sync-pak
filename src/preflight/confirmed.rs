...
use crate::{preflight::Preflight, preflight::destructive_confirmation::DestructiveConfirmation};
...
pub enum StartError {
    ...
    Confirmation(crate::preflight::destructive_confirmation::ConfirmationError),
}
