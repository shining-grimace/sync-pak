...
use crate::{
    inventory::remote::normalize_prefix,
    operations::transfer::paths::LocalTransferRoot,
    providers::capabilities::{ObjectPrefixChecker, ProviderError},
};
...
mod tests {
    ...
    use crate::providers::capabilities::{ObjectPrefixChecker, ProviderResult};
