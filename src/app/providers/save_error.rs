...
impl From<crate::operations::operation_cancellation::ProviderDeletionError>
    for ProviderPersistenceError
{
    fn from(error: crate::operations::operation_cancellation::ProviderDeletionError) -> Self {
        match error {
            crate::operations::operation_cancellation::ProviderDeletionError::Provider(error) => {
                Self::from(error)
            }
            crate::operations::operation_cancellation::ProviderDeletionError::Cancellation(_) => {
                Self::OperationCancellation
            }
            crate::operations::operation_cancellation::ProviderDeletionError::Configuration(_) => {
                Self::Other
            }
        }
    }
