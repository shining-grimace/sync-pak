...
use crate::{
    AppWindow, app::activity::presentation::ActivityPresentation,
    operations::execution::OperationExecutor, operations::queue::QueueState,
    operations::queue::background::BackgroundQueue, preflight::planning::Direction,
};
...
fn result_counts(
    result: Option<&crate::operations::execution::ExecutionResult>,
) -> (i32, i32, i32) {
...
mod tests {
    ...
    use crate::{operations::queue::QueueState, preflight::planning::Direction};
