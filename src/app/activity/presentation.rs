use crate::{
    ...
    operations::execution::ExecutionState,
...
fn detail(snapshot: &crate::operations::queue::snapshot::ActivitySnapshot) -> String {
    format!(
        "{} · {} · {} → {}",
        mode(snapshot.mode),
...
fn summary(result: &crate::operations::execution::ExecutionResult) -> String {
    match result.state {
...
fn incomplete_summary(
    result: &crate::operations::execution::ExecutionResult,
    state: &str,
) -> String {
...
fn result_details(result: &crate::operations::execution::ExecutionResult) -> Vec<String> {
...
fn action_details(
    status: &str,
    actions: &[crate::preflight::planning::PlannedAction],
) -> Vec<String> {
    actions
        .iter()
...
fn action_name(action: &crate::preflight::planning::PlannedAction) -> String {
    use crate::preflight::planning::PlannedAction;
