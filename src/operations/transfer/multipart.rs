...
use crate::{
    ...
    providers::capabilities::{
        MultipartUpload, MultipartUploadRequest, MultipartUploader, UploadedPart,
    },
};
...
pub enum MultipartUploadError {
    #[allow(
        dead_code,
        reason = "the in-memory multipart executor constructs this during tests"
    )]
    Cancelled { abort_error: Option<ProviderError> },
    Provider {
        error: ProviderError,
